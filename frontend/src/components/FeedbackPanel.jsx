          ...
          <div className="space-y-5 animate-fade-in">
            ...
            <div>
              ...
              <div className="space-y-3">
                <DimensionBar label="Clarity"   score={feedback.scores.clarity} />
                <DimensionBar label="Relevance" score={feedback.scores.relevance} />
                <DimensionBar label="Depth"     score={feedback.scores.depth} />
                <DimensionBar label="Structure" score={feedback.scores.structure} />
                <DimensionBar label="Impact"    score={feedback.scores.impact} />
              </div>
            </div>
